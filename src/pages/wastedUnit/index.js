            ...
            <Grid container spacing={2}>
                ...
                <Grid item spacing={2} >
                    ...
                    <Grid item xs={8} style={{ paddingBottom: '10px' }}>
                        ...
                        {userError && (
                            <Typography style={{ fontSize: '0.75rem', width: '100%', display: 'flex' }} color="error" variant="subtitle1">
                                User is required
                            </Typography>
                        )}
                                ...
                                <Grid container className={classes.countContainer}>
                                    ...
                                    <Grid xs={2} style={{ display: 'flex', flexDirection: 'row-reverse' }}>
                                        ...
                                        >
                                            ...
                                            >
                                                Mark as Wasted
                                                {requestbatchActionsLoading && selectedStatus === 'BS-TR-5110' && (
                                                    <CircularProgress size="20px" style={{ marginLeft: '10px' }} />
                                                )}
                                            </MenuItem>
                                            <MenuItem
                                            ...
                                            >
                                                Mark as Transfused
                                                {requestbatchActionsLoading && selectedStatus === 'BS-TR-5119' && (
                                                    <CircularProgress size="20px" style={{ marginLeft: '10px' }} />
                                                )}
                                            </MenuItem>
                                        </Menu>
