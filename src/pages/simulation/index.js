...
const Simulation = (props) => {
    ...
    const mData = data && data?.length > 1 ? data[1] : data;
    console.log('mdata--', mData)
    const label = mData?.label;
    let breadScrumbLebel = data?.label;
    ...
    const handleStatusClick = (status) => {
        ...
        if (status === 'request' || status === 'Assigned') {
            handleRequestFilter(status);
        }
    };

    const handleRequestFilter = (status) => {
        ...
        const chipData = [status];

        const chipNameAndId = { [status]: status };
        ...
        console.log(chipNameAndId, 'chipNameAndId', status, chipData);
        dispatch(getApplyFilters(newFiltersObject));
        history.push('/dashboard/remoteassign');
    };
    ...
    const setDashboardFilter = () => {
        requestBatchfiltersData?.data?.['trackId-name'].map((val) => {
                                                                            ...
                                                                            >
                                                                                {responseData?.data?.map(
                                                                                    (
                                                                                        ...
                                                                                        <Grid item key={index} style={{ padding: '5px', paddingTop: '10px' }}>
                                                                                            <Card style={{ padding: '5px', width: '800px' }}
                                                                                                className={
                                                                                                    obj.status ===
                                                                                                        'request'
                                                                                            ...
                                                                                            >
                                                                                                <div style={{ display: 'flex' }}>
                                                                                                    <div style={{ width: 'calc(50% - 5px)', borderRight: '2px solid black', paddingRight: '5px' }}>
                                                                                                        <table>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>MRNNumber:</td>
                                                                                                                <td style={{
                                                                                                                    paddingLeft: '25px', color: 'black', fontSize: '18px' }}>{obj?.recipientId ? obj?.recipientId[0].mrnNumber : '-'}</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>RecipientName:</td>
                                                                                                                <td style={{ paddingLeft: '25px', color: 'black', fontSize: '18px' }}>{obj?.recipientId[0]?.name}</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>DOB:</td>
                                                                                                                <td style={{ paddingLeft: '25px', color: 'black', fontSize: '18px' }}>{obj?.recipientId[0]?.dob ? moment(obj.recipientId[0]?.dob).format
                                                                                                                    ('DD-MM-YYYY') : '-'}</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>Gender:</td>
                                                                                                                <td style={{ paddingLeft: '25px', color: 'black', fontSize: '18px' }}>{obj?.recipientId[0]?.gender}</td>
                                                                                                            </tr>
                                                                                                            {/*<tr>*/}
                                                                                                            {/*    <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>BloodGroup:</td>*/}
                                                                                                            {/*    <td style={{ paddingLeft: '25px' }}>{obj?.recipientId[0]?.bloodgroupId}</td>*/}
                                                                                                            {/*</tr>*/}
                                                                                                        </table>
                                                                                                    </div>
                                                                                                    <div style={{ width: 'calc(50% - 10px)' }}>
                                                                                                        <table style={{ paddingLeft: '20px' }}>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>No.of Units:</td>
                                                                                                                <td style={{ paddingLeft: '25px', fontWeight: 'bold', color: 'red', fontSize: '18px' }}>{obj.numberOfUnits}</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>Comments:</td>
                                                                                                                <td style={{ paddingLeft: '25px', color: 'black', fontSize: '18px' }}>{obj.comments}</td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div style={{ display: 'flex', alignItems: 'center' }}>
                                                                                                    <div style={{ flex: '1' }}>
                                                                                                        <table style={{ paddingLeft: '2px' }}>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>RequestedBy:</td>
                                                                                                                <td style={{ paddingLeft: '25px', color: 'black', fontSize: '18px' }}>{obj.createdBy[0]?.name}</td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </div>
                                                                                                    <div style={{ flex: '1', textAlign: 'right' }}>
                                                                                                        <table style={{ paddingLeft: '2px' }}>
                                                                                                            <tr>
                                                                                                                <td style={{ color: 'black', fontWeight: 'bold', fontSize: '18px' }}>Status:</td>
                                                                                                                <td style={{ paddingLeft: '25px', fontWeight: 'bold', color: '#0000BF', fontSize: '18px', cursor: 'pointer' }}
                                                                                                                    onClick={() => handleStatusClick(obj.status)}
                                                                                                                >
                                                                                                                    {obj.status === 'request' ? 'Request Pending' : obj.status}</td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </div>
                                                                                                </div>
