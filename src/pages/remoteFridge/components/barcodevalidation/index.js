...
const BarcodeValidation = (props) => {
    ...
    const handleSave = () => {
        ...
        setBloodGroup(unitIdData?.data?.[0]?.bloodgroupId?.[0]?.name);
            ...
            if (unitsTable.length === 0 && unitId.length > 11 ) {
                setUnitsTable([
                    {
    ...
    const handleAddSave = () => {
        if (unitId === scanSplitted[6] && productCode?.isbtcode === scanSplitted[7]) {
            let slipId = compatabilityPdfSlipdata?.data?.slipData?._id
            dispatch(validationSlipUpdate('verified', slipId)); 
            if (unitsTable.length === 0 && unitId.length > 11) {
                setUnitsTable([
                    {
                        unitId: scanSplitted[6],
                        productCode: scanSplitted[7],
                        //description: productCode.isbtdescription,
                        tableDRdate: scanSplitted[10],
                        firstName: scanSplitted[2],
                        lastName: scanSplitted[1],
                        expiryDate: scanSplitted[8],
                        //tableDRdate: tempUnitId?.isAssigned
                        //    ? tempUnitId?.dereservationDate
                        //    : '-',
                        ////tableDRdate: getDreservationDatetime(tempUnitId.productcodeId?.productgroupId),
    ...
    const handlePaste = (e) => {
        ...
        if (unitId === splittedValues[6] && productCode?.isbtcode === splittedValues[7]) {
            setTick(true);
        }
        else {
            setTick(false);
                    ...
                    <Grid container item xs={12} lg={12} md={12} className={classes.minHeight}>
                        <Grid container item>
                            ...
                            <Grid item xs={5} className={classes.addUnitsButton}>
                                <Grid item lg={3} xs={4}>
                                    <CustomButton fullWidth variant="contained" color="primary" onClick={handleDialogOpen}>
                                        {CONSTANTS.ADD}
                                    </CustomButton>
                                </Grid>
                                <Dialog
                                ...
                                >
                                    <DialogTitle>
                                        <Typography color="primary" component="span" variant="h5">
                                            Validate cross  match compatibility slip
                                        </Typography>
                                    </DialogTitle>
                                    <DialogContent>
                                            ...
                                            {showUnitIdInput && (
                                                <Grid item xs={12}>
                                                    ...
                                                    ></Grid> <Grid
                                                        ...
                                                        md={12}
                                                    ></Grid>
                                                    <Grid xs={6} style={{ marginLeft: '300px' }}>
                                                        <CustomButton
                                                            variant="contained"
                                                            color="primary"
                                            ...
                                            <Grid item container xs={12}>
                                                ...
                                                />
                                                    ...
                                                    <Grid
                                                        ...
                                                        md={12}
                                                    ></Grid>
                                                <Grid xs={6} style={{ marginLeft: '430px' }}>
                                                        <CustomButton
                                                            variant="contained"
                                                            color="primary"
                                        ...
                                        {showCompatibilityInput && (
                                            <Grid container spacing={2} alignItems="center">
                                                ...
                                                {tick === true ?
                                                    ...
                                                    : tick === false ? <Grid style={{ alignItems: 'center', }}>
                                                        <CancelOutlined
                                                            style={{
                                                                color: 'red',
                                                                width: '3em',
                                    ...
                                    <DialogActions className={classes.action}>
                                        {showCompatibilityInput && (
                                            <Grid xs={12} style={{ display: 'flex' }}>
                                                ...
                                                <Grid xs={6} style={{ marginLeft: '280px' }}>
                                                    <CustomButton
                                                        variant="contained"
                                                        color="primary"
            ...
            >
                ...
                <DialogContent>
                    <Grid item xs={12} >
                        ...
                        //key={input.name}
                        >
                            <InputLabel className={classes.inputLabel}>Scan Compatability slip here</InputLabel>
                            <CustomInput
                                // key={input.name}
                ...
                <DialogContent>
                    <>
                        <Grid item xs={12} style={{ display: 'flex' }}>
                            ...
                            //key={input.name}
                            >
                                <InputLabel className={classes.inputLabel}>Unit ID</InputLabel>
                                <CustomInput
                                    // key={input.name}
                                    //onChange={isEdit ? handleEditChange : isClone ? handleEditChange : onFormChange}
                                    //name={input.name}
                        ...
                        <Grid style={{ display: 'flex' }}>
                            ...
                            >
                                <InputLabel className={classes.inputLabel}>Scan Compatability slip </InputLabel>
                                <CustomInput
                                    // key={input.name}
                                    //onChange={isEdit ? handleEditChange : isClone ? handleEditChange : onFormChange}
                                    //name={input.name}
                            ...
                            >
                                ...
                                <DoneIcon style={{ width: '40px', height: '40px', color: 'green' }} />
                                <CloseIcon style={{ width: '40px', height: '40px', color: 'red' }} />
                            </Grid>
                        </Grid>
...
export default BarcodeValidation;
