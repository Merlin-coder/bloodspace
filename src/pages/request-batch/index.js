...
const RequestBatch = (props) => {
    ...
    const urlEndPoint = 'assignbatches';
    ...
    useEffect(() => {
        dispatch(getRequestBatchFilter(remoteInfo?.emergencyLogin === 'TRUE' ? '6320991b7d29280d14a57145' : undefined));
    }, [options8]);
