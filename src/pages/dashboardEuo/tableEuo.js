...
export default function EuoDashboardTable({ columns, response, groupBy, total, hospitalFilters }) {
    ...
    const route = (value, name, group) => {
        ...
        if (groupBy === 'Product') {
            filtersData = [
                { key: 'productgroupId._id', value: [group?.product?._id] },
                { key: 'bloodgroupId._id', value: [value?._id && value?._id] },
                hospitalFilters
            ];
            chipData = [name, group?.product?.value];
            if (name === 'Total') {
                filtersData = [{ key: 'productgroupId._id', value: [group?.product?._id] }];
